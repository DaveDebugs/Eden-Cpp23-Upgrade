...
static void PrintVersion() {
    LOG_INFO(Network, "Eden dedicated room {} {} Libnetwork: {}", static_cast<const char*>(Common::g_scm_branch),
             static_cast<const char*>(Common::g_scm_desc), Network::network_version);
}
