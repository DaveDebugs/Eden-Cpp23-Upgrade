...
GRenderWindow::GRenderWindow(MainWindow* parent,
    ...
    setWindowTitle(QStringLiteral("Eden %1 | %2-%3")
                       .arg(QString::fromUtf8(static_cast<const char*>(Common::g_build_name)),
                            QString::fromUtf8(static_cast<const char*>(Common::g_scm_branch)),
                            QString::fromUtf8(static_cast<const char*>(Common::g_scm_desc))));
