...
EmuWindow_SDL3_GL::EmuWindow_SDL3_GL(InputCommon::InputSubsystem* input_subsystem_,
    ...
    std::string window_title = std::format("{} | {}-{}", static_cast<const char*>(Common::g_build_fullname),
    ...
    SDL_PumpEvents();
    LOG_INFO(Frontend, "Build string: {} | {}-{}", static_cast<const char*>(Common::g_build_fullname), static_cast<const char*>(Common::g_scm_branch),
